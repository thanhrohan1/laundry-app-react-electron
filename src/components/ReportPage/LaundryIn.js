...
const LaundryIn = ({ transactions, totalLaundryIn }) => {
              ...
              .map((transaction, index) => (
                <React.Fragment key={index}>
                  <tr className='flex w-full items-center text-center mb-4'>
                    ...
                    <td className='w-3/12'>
                      {handleShowMoney(transaction.uangCustomer)}
                    </td>
                    <td className='w-2/12'>
                      <button
                        onClick={() => {
